...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section className="video-footer-strip" aria-label="Miami Skate Academy session video"><video autoPlay muted loop playsInline preload="metadata" aria-hidden="true"><source src="/videos/msa-skate.mp4" type="video/mp4" /></video><div className="video-footer-overlay" /></section>

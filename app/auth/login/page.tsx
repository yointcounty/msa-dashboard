...
export default function LoginPage() {
  ...
  return <main className="auth-shell">
    <section className="auth-visual"><Image src="/images/msa-lessons.webp" alt="Miami Skate Academy community at the skatepark" fill priority sizes="(max-width: 900px) 100vw, 50vw"/><div className="auth-visual-copy"><h2>WELCOME BACK<br/><em>TO THE CREW.</em></h2><p>Schedules, milestones, and coach updates—all in one family-friendly place.</p></div></section>
